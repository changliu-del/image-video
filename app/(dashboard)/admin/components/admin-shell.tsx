...
function buildManagementConfigs(
  ...
  return {
    ...
    'user-media': {
      key: 'user-media',
      title: management['user-media'].title,
      description: management['user-media'].description,
      searchPlaceholder: management['user-media'].searchPlaceholder,
      idField: 'id',
      icon: Images,
      deleteEnabled: true,
      columns: [
      ...
      columnLabels: {
        ...management['user-media'].fields,
        ...management['user-media'].columns,
      },
      columnWidths: {
        assetId: 220,
        title: 260,
      ...
      editableFields: [
        {
          key: 'title',
          label: management['user-media'].fields.title,
        },
        {
          key: 'isFavorite',
          label: management['user-media'].fields.isFavorite,
          type: 'select',
          options: [
            { value: 'false', label: statusLabels.false },
            { value: 'true', label: statusLabels.true },
          ],
        },
        {
          key: 'visibility',
          label: management['user-media'].fields.visibility,
          type: 'select',
          options: [
            { value: 'active', label: statusLabels.active },
            { value: 'hidden', label: statusLabels.hidden },
            { value: 'deleted', label: statusLabels.deleted },
          ],
        },
      ],
    },
