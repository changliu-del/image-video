...
describe('imageToVideoGenerationRequestSchema', () => {
  it('defaults image-to-video to 5s and maps duration to credit cost', () => {
    ...
    expect(getCreditCostForDuration(IMAGE_TO_VIDEO_DURATION_SECONDS)).toBe(15);
  ...
  it('accepts 5-15s image-to-video durations and scales credit cost', () => {
    ...
    expect(getCreditCostForGeneration(tenSecondVideo)).toBe(30);
    expect(getCreditCostForGeneration(fifteenSecondVideo)).toBe(45);
  });
  ...
  it('prices Pro image-to-video mode from its higher provider cost', () => {
    ...
    expect(getCreditCostForGeneration(proVideo)).toBe(45);
    expect(
      getCreditCostForDuration(10, { videoModelMode: 'wanxiang_2_7' })
    ).toBe(85);
    expect(
      getCreditCostForDuration(15, { videoModelMode: 'wanxiang_2_7' })
    ).toBe(130);
  });
