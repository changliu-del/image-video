...
- Pricing basis: Brazilian local-company/Pix MVP uses 3x provider cost markup and an exact conversion of 1 credit = R$0.50.
- Image-to-video basic mode (`wanxiang_2_6_first_frame`, Wanxiang 2.6 flash 720P no-audio): costs are derived from provider CNY/second cost, CNY->BRL rate snapshot, 3x markup, and R$0.50 credits; default 5s costs 5 credits.
- Image-to-video Pro mode (`wanxiang_2_7`, Wanxiang 2.7 720P): default 5s costs 17 credits.
...
- The Brazil/Pix credit wallet uses BRL catalog prices and exact top-up conversion: 20 credits = R$10, 80 credits = R$40, 240 credits = R$120.
- Monthly subscription allowances are Basic 60 credits / R$30, Plus 180 credits / R$90, and Pro 480 credits / R$240 before annual discount.
